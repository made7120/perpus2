...
st.markdown(
    ...
    <style>
    .stApp {
        background-image: url("https://i.ibb.co.com/3N6hY1T/galak3.webp");
...
st.markdown("<div style='text-align: center; margin-top: 50px;'>© 2024 Salsa</div>", unsafe_allow_html=True)
